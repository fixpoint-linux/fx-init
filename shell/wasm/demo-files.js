...
export const PACKAGE_SET = `-- demo/package-set.dhall — the in-browser userland demo package set.
...
`;
export const CONFIG = `-- demo/config.dhall — m3/config-good.dhall adapted for the browser demo:
