 ...
 *   3. For each content page (from PAGES): mounts Elm.Main.init with
 ...
 *      The site is content-only, so unlike shen/visage there are no wasm /
 *      xterm / CodeMirror docs assets to copy.
 *
