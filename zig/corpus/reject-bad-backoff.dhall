...
in { hostname = "x", packages = [] : List Text, users = [] : List U,
     services = [ { name = "a", argv = ["x"], pkg = None Text, on = "all", restart = None Text, backoffMs = Some 99999999999999999999999999, probe = None Probe, env = None (List { key : Text, value : Text }) } ],
