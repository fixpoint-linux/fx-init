...
in { hostname = "x", packages = [] : List Text, users = [] : List U,
     services = [ { name = "a", argv = ["x"], pkg = None Text, on = "time:-99999999999999999999", restart = None Text, backoffMs = None Natural, probe = None Probe, env = None (List { key : Text, value : Text }) } ],
