-- good.dhall — unit-6 diff fixture: a healthy boot.  heartbeat = fakesvc ok
-- (prints "heartbeat from heartbeat"), started-as-ready (no probe), so the
-- boot reaches ok within bootGraceMs (1500ms — small for the smoke diff).
